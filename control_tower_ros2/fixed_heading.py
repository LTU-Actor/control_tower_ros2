...
class FixedHeadingSteering:
    ...
    def __init__(self, velocity, angle, l=0.711, w=0.558):
        """
        Key Variable Units:
    ...
    def compute_steering(self):
        ...
        self.theta_f_right = self.angle
        self.theta_f_left = self.angle
        self.theta_r_right = self.angle
        self.theta_r_left = self.angle
